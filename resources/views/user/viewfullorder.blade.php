          ...
          <div class="panel panel-default">
            <div class="panel-heading">
              <div class="panel-title">
                ...
                @if(isset($orivar->products) && $orivar->products->return_avbl == '1')
                @if($o->status == 'delivered')
                ...
                @if($o->status == 'delivered')
                  @if(isset($o->simple_product) && $o->simple_product->type == 'd_product')
                    <a title="Download your item" href="{{ URL::temporarySignedRoute('user.download.order', now()->addMinutes(2), ['orderid' => $o->id]) }}"
                      class="mr-2 pull-right btn btn-sm bg-success text-light"><i class="fa fa-download" aria-hidden="true"></i>
                      {{ __('Download') }}
                    </a>
                  @endif
                @endif
