    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form action="{{ route('user.bank.update',$bank->id) }}" method="POST">
          ...
          <div class="form-group">
            <label>{{ __('IFSC Code/ SWIFT CODE') }}: <span class="required">*</span></label>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ route('user.bank.add') }}" method="POST">
          ...
          <div class="form-group">
            <label class="font-weight-bold">{{ __('IFSC Code/ SWIFT CODE') }}: <span class="required">*</span></label>
