  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">{{__("seller.Request New Brand")}}</h4>
      </div>
      <div class="modal-body">
       	<form action="{{ route('request.brand.store') }}" method="POST" enctype="multipart/form-data">
       		...
       		<div class="form-group">
       			<label>{{__("seller.Brand Name")}}: <span class="required">*</span></label>
       			<input required="" name="name" type="text" class="form-control" placeholder="Enter brand name">
       		</div>

       		<div class="form-group">
       			<label for="">{{__("seller.Brand Logo")}}: <span class="required">*</span></label>
       			<input required="" type="file" name="image" class="form-control">
       		</div>

       		<div class="form-group">
       			<label>{{__("seller.Categories")}}: <span class="required">*</span></label>
       			...
       			<p class="help-block">({{__("seller.Select categories for brand availability")}})</p>
       		</div>

       		<div class="form-group">
       			<label for="">{{__("seller.Brand Proof")}}:</label>
       			<input type="file" name="brand_proof" class="form-control">
       			<p class="help-block">({{__("seller.Required if you submitting your own brand")}})</p>
       		</div>

       		<button type="submit" class="btn btn-md btn-flat bg-blue"><i class="fa fa-arrow-right"></i> {{__("seller.Request") }}</button>
