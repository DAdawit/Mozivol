      ...
      <ul class="sidebar-menu" data-widget="tree">
       ...
       @canany(['stores.accept.request','stores.view'])
        ...
        @can('sellersubscription.manage')
          <li class="treeview {{ Nav::isRoute('seller.subs.listofsubs') }} {{ Nav::isResource('plans') }}">
            <a href="#">
        ...
        @canany(['others.abuse-word-manage','site-settings.bank-settings','site-settings.dashboard-settings','site-settings.footer-customize','site-settings.genral-settings','site-settings.genral-settings','site-settings.language','site-settings.mail-settings','site-settings.maintenance-mode','site-settings.sms-settings','site-settings.social-handle','site-settings.social-login-settings','site-settings.style-settings'])
        <li id="sitesetting"
          class="treeview {{ Nav::isRoute('sms.settings') }} {{ Nav::isRoute('get.view.m.mode') }} {{ Nav::isRoute('customstyle') }} {{ Nav::isRoute('site.lang') }} {{ Nav::isResource('admin/abuse') }} {{ Nav::isResource('admin/bank_details') }} {{ Nav::isRoute('genral.index') }} {{ Nav::isRoute('mail.getset') }} {{ Nav::isRoute('gen.set') }} {{ Nav::isRoute('footer.index') }} {{ Nav::isResource('social') }} {{ Nav::isResource('page') }} {{ Nav::isResource('blog') }} {{ Nav::isRoute('seo.index') }} {{ Nav::isRoute('api.setApiView') }} {{ Nav::isRoute('get.paytm.setting') }} {{ Nav::isResource('page') }} {{ Nav::isRoute('admin.dash') }} {{ Nav::isRoute('static.trans')  }}">
          <a href="#">
