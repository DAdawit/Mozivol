      ...
      <ul class="nav navbar-nav navbar-right">
        <li class="nav-item">
          <div class="quant-input">
            <input type="number" value="{{ $product->min_order_qty }}" max="{{ $product->max_order_qty }}" class="qty-section">
          </div>
        </li>
          ...
          <div id="cartForm">
            <div id="cartForm">
                ...
                @if($product->type == 'ex_product')
                  ...
                  <a href="{{ $product->external_product_link }}" role="button" class="btn btn-cart"><i class="fa fa-shopping-cart" aria-hidden="true"></i> {{__("Buy Now")}} <span class="sr-only">(current)</span></a>
               
                @else

                <form action="" method="POST">

                  <button type="submit" class="btn btn-cart"><i class="fa fa-shopping-cart" aria-hidden="true"></i> {{__("staticwords.AddtoCart")}} <span class="sr-only">(current)</span></button>
                ...
                <div class="item hot-deals-item">
                  <div class="products">
                    ...
                    <div class="product-info text-left m-t-20">
                      ...
                      @php
                            $ratings_var2 = ProductRating::getReview($value);
                      @endphp
                    ...
                    <div class="cart clearfix animate-effect">
                      <div class="action">
                        <ul class="list-unstyled">
                          ...
                          @endphp
                          @if($value->selling_start_at == '' || $value->selling_start_at <= date("Y-m-d H:i:s"))
              ...
              <div class="product-item-holder size-big single-product-gallery small-gallery">
                ...
                <div class="data-sticky ">
                  ...
                  <div id="single-product-gallery-item">
                    ...
                    <center><img alt="miniproductimage"
                        src="{{ url('images/simple_products/gallery/'.$product->productGallery[0]['image']) }}"
                        class="img img-fluid zoom-img drift-demo-trigger"
                  ...
                  <div class="mt-5 galleryContainer">
                    <div id="productgalleryItems"
                      ...
                      <div class='provarbox'>
                        ...
                        <img onclick="changeImage('{{ url('images/simple_products/gallery/'.$gallery->image) }}')"
                  ...
                  <div class="notifymeblock">
                    <form action="#" method="post">
                      ...
                      <button type="button" data-target="#notifyMe" data-toggle="modal"
                        class="m-1 p-2 btn btn-md btn-block btn-primary">{{ __("NOTIFY ME") }}</button>
                    </form>
                  </div>
                  @endif
                </div>
                                    ...
                                    <div class="cart-quantity">
                                      <div class="quant-input">
                                        <input type="number" value="1" name="qty" min="{{ $product->min_order_qty }}"
                                          max="{{ $product->max_order_qty }}" maxorders="null" class="qty-section">
                                      </div>
                                    </div>
                                    <div class="add-btn">
                                      @if($product->type == 'ex_product')
                      ...
                      <div class="col-sm-6 col-xs-12 col-md-8">
                        <div class="price-box price-box-border">
                          ...
                          <span class="price price-main dtl-price-main">
                            ...
                            {{ $product->offer_price != 0 || $product->offer_price != '' ? $product->offer_price * $conversion_rate : ""  }}
                          </span>
                          <span class="margin-top-15 font-size-20 price-strike price-strike-main dtl-price-strike-main">
                            <i class="{{ session()->get('currency')['value'] }}"></i> {{ $product->price * $conversion_rate }}
                          </span>
                          @else 

                          <span class="price price-main dtl-price-main">
                            <i class="{{ session()->get('currency')['value'] }}"></i>
                            {{ sprintf("%.2f",$product->price * $conversion_rate) }}
                          </span>
                        ...
                        @endphp
                        <div class="progress-text">{{ $offamount }}% off</div>
                        <div class="progress">
                          <div style="width: {{ $offamount }}%" class="progress-bar" role="progressbar"
                            aria-valuenow="{{ $offamount }}" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
