                                                ...
                                                <div class="tab-content outer-top-xs">
                                                    <div class="product-slider">
                                                        <div class="product-slider-main-block">
                                                                ...
                                                                <mobile-product v-if="!loading" :date="date" :lang="lang" :fallbacklang="fallbacklang" :login="login" :guest_price="guest_price" :products="products" :new_simple_products="mob_simple_products"></mobile-product>
                                              ...
                                              <div class="tab-content outer-top-xs">
                                                  <div class="product-slider">
                                                      <div class="product-slider-main-block">
                                                            ...
                                                            <mobile-product v-if="!loading" :date="date" :lang="lang" :fallbacklang="fallbacklang" :login="login" :guest_price="guest_price" :products="featuredproducts" :new_simple_products="featured_simple_producrs"></mobile-product>
...
export default {
    props : [
        "products","guest_price","login","fallbacklang","lang","date","featuredproducts","top_products","mob_simple_products","featured_simple_producrs"
    ],
    components : {
