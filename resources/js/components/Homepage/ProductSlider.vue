<template>
    <div>
        ...
        <div :key="Math.random().toString(36).substring(7)"
            ...
            <div v-for="(product,index) in simple_products" :key="Math.random().toString(36).substring(7)+index+product.productid" class="item item-carousel">
                            ...
                            <div class="action">
                                <ul class="list-unstyled">
                                    ...
                                    <li v-if="product.type != 'ex_product'" v-show="guest_price == '0' || login == 1" id="addCart" class="lnk wishlist">
                                        ...
                                        <form @submit.prevent="addToCartSimple(product.cartURL)">
                                            <button :title="translate('staticwords.AddtoCart')" type="submit"
                                                class="addtocartcus btn"><i class="fa fa-shopping-cart"></i>
                                            </button>
                                        </form>
                                    ...
                                    <span v-if="login == 1">
                                        ...
                                        <li :class="{'active' : product.is_in_wishlist == 1}" class="lnk wishlist">
                                            ...
                                            <form @submit.prevent="addtowishsimple(product.productid)">
                                                <button type="submit" :class="{'text-dark' : product.is_in_wishlist == 1}"
                                                    class="addtocartcus btn"><i class="fa fa-heart"></i>
                                                </button>
                                            </form>
