<template>
    <section class="mt-2 section new-arriavls feature-product-block">
       ...
       <div>
           <product-slider v-if="products" :products="products" :simple_products="simple_products" :date="date" :lang="lang" :fallbacklang="fallbacklang" :login="login" :guest_price="guest_price"></product-slider>
